package de.ait_tr.g_36.security.security_service;

import de.ait_tr.g_36.domain.entity.Role;
import de.ait_tr.g_36.repository.RoleRepository;
import de.ait_tr.g_36.security.AuthInfo;
...
public class TokenService  {
    ...
    public TokenService(
            @Value("${spring.key.access}") String accessSecretPhrase,
            @Value("${spring.key.refresh}") String refreshSecretPhrase,
    ...
    public String generateAccessToken(UserDetails user) {
        ...
        // Instant expirationInstant = currentDate.plusMinutes(2).atZone(ZoneId.systemDefault()).toInstant(); // дата в будущем на плюс 2 минуты от сейчас
